...
while True:
    ...
    if finger.count_templates() != fingerprint.OK:
        raise RuntimeError("Failed to read templates")
    print("Number of templates found: ", finger.template_count)
    if finger.read_sysparam() != fingerprint.OK:
    ...
    if c == "d":
        if finger.delete_model(get_num(finger.library_size)) == fingerprint.OK:
            print("Deleted!")
        else:
    ...
    if c == "r":
        if finger.empty_library() == fingerprint.OK:
            print("Library empty!")
        else:
