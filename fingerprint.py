...
class Fingerprint:
    ...
    def __init__(self, uart: Serial, passwd: (int, int, int, int) = (0, 0, 0, 0)):
    ...
    def get_fpdata(self, sensorbuffer: str = "char", slot: int = 1) -> [int]:
    ...
    def send_fpdata(
        self, data: [int], sensorbuffer: str = "char", slot: int = 1
    ) -> bool:
    ...
    def _get_packet(self, expected: int) -> [int]:
    ...
    def _get_data(self, expected: int) -> [int]:
    ...
    def _send_packet(self, data: [int]):
    ...
    def _print_debug(self, info: str, data: [int, str], data_type: str = "str"):
